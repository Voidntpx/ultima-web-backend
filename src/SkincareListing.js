...
const SkincareListing = () => {
    ...
    const Removefunction = (id) => {
        if (window.confirm('Do you want to remove?')) {
            fetch("https://apiservice-d5qtigtmea-as.a.run.app/skincare/" + id, {
                method: "DELETE"
            }).then((res) => {
    ...
    useEffect(() => {
        fetch("https://apiservice-d5qtigtmea-as.a.run.app/skincare/checkall",{
        ...
        <div className="container cosmetic-content h-100">
            <div className="ca h-100">
                ...
                <div className="card-title ps-4 py-4 ms-4 my-2 d-flex align-items-center animate__animated animate__delay-1s animate__fadeInUp">
                    ...
                    <h2 className=" title ps-2">Skincare List</h2>
                </div>
